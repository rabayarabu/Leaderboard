...
**Leaderboard** In this project you will find a JavaScript project for the Leaderboard list app, using webpack and ES6 features, notably modules.
...
```sh
  cd my-folder
  git clone git@github.com:rabayarabu/Leaderboard.git
```
...
Feel free to check the [https://github.com/rabayarabu/Leaderboard/issues](../../issues/).
